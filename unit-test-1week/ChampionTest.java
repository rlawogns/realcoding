...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        assertThat(sampleString1,anyOf(notNullValue())); //조건 여러개
    ...
    public void shouldTopChampionIsDarius() {
        Optional<Champion> filterdChampion = championList.stream()
                ...
                .findFirst();
        assertThat(filterdChampion.get().getName(),is("다리우스"));
        assertTrue(filterdChampion.get().getPosition().equals("탑"));
